...
class Device(Base):
    ...
    # X25519 public key, hex. Generated by the device on first boot and sent
    # in every hello. The server needs it to wrap a firmware content key that
    # only this device can unwrap. Public by definition -- safe to store, log
    # and display.
    x25519_public_key: Mapped[str | None] = mapped_column(String(64))
